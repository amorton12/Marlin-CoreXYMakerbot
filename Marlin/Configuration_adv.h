...
#define HOMING_BACKOFF_POST_MM { 1, 1, 2 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     630 // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      100  // (mm/s) feedrate to purge before unload
