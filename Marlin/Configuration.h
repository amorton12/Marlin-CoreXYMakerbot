...
#define STRING_CONFIG_H_AUTHOR "Andrew Morton" // Original author or contributor.
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 153.20
  #define DEFAULT_bedKi 17
  #define DEFAULT_bedKd 920.3
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 177.8, 177.8, 400, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -25, -3.40 }
